...
1. Clone o repositório:
   ```bash
   git clone https://github.com/seu-usuario/semana-da-tecnologia.git
   ```
...
- Tabela de cronograma com cabeçalho estilizado
- Formulário com campos de nome e e-mail
- Container centralizado com largura máxima de 600px
